    ...
    return (
        <View style={styles.containerPrincipal}>
                    ...
                    <View style={styles.estiloViewPicker}>
                        <Picker
                            ...
                            onValueChange={(itemValor, itemIndex) =>
                                setValorPicker(itemValor)
                            }>
                            <Picker.Item label="Categorias" value=""/>
                            <Picker.Item
                                label="Adminstrativo / Secretariado / Finanças"
                                value="1"
                            />
                            <Picker.Item label="Comercial / Vendas" value="2"/>
                            <Picker.Item
                                label="Telecomunicações / Informática / Multimídia"
                                value="3"
                            />
                            <Picker.Item
                            ...
                            />
                            <Picker.Item
                                label="Banco / Seguros / Consultoria Jurídica"
                                value="5"
                            />
                            <Picker.Item label="Logística / Distribuição" value="6"/>
                            <Picker.Item
                                label="Turismo / Hotelaria / Restaurante"
                                value="7"
                            />
                            ...
                            <Picker.Item
                                label="Agricultura / Pecuária / Veterinária"
                                value="13"
                            />
                            <Picker.Item
                                label="Engenharia / Arquitetura / Design"
                                value="14"
                            />
                        </Picker>
                    </View>
            ...
            <View style={{flexDirection: 'row'}}>
                ...
                <TouchableOpacity onPress={() => loadUsuarios(text)}>
            ...
            <TouchableOpacity
                ...
                <Text style={{color: '#FFF', fontSize: 17}}>
                    {' '}
                    Filtrar <Icon name="caret-down" color={'#FFFF'} size={25}/>
                </Text>
            </TouchableOpacity>
